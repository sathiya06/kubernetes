...
import (
	...
	cachev1alpha1 "github.com/sathiya06/kubernetes/operators/memcached-operator/api/v1alpha1"
)

const memcachedFinalizer = "cache.killjoy.com/finalizer"
...
// +kubebuilder:rbac:groups=cache.killjoy.com,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cache.killjoy.com,resources=memcacheds/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=cache.killjoy.com,resources=memcacheds/finalizers,verbs=update
...
func (r *MemcachedReconciler) doFinalizerOperationsForMemcached(cr *cachev1alpha1.Memcached) {
	...
	// needs to do before the CR can be deleted. killjoys
